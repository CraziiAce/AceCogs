    ...
    async def zip(self, ctx, zip_code:str):
        ...
        async with aiohttp.ClientSession() as session:
            ...
            embed = discord.Embed(
                    ...
                    description=f"weather_response['weather']['main']",
                    color=0x0276FD,
            )
            ...
            embed.set_thumbnail(url=f"https://openweathermap.org/img/wn/{weather_response['weather']['icon']}@2x.png")
            embed.set_footer(text='Starry | discord.gg/7mSqpXN', icon_url='')
